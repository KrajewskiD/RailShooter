...
public static class PermutationTable
{
    public static readonly int[] Perlin = new int[]
    {
        ...
        200,196,135,130,116,188,159,86,164,100,109,198,
    ...
    public static void BuildPermutation512(int seed, NativeArray<int> output)
    {
        for (int i = 0; i < 256; i++)
        {
            output[i] = Perlin[i];
